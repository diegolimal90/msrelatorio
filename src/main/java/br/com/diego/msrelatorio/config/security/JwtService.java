...
public class JwtService {
    ...
    public String generateToken(User user) {
        return generateToken(UserEntityMapper.from(user));
    }
    ...
    public String generateRefreshToken(
        ...
        return generateRefreshToken(UserEntityMapper.from(user));
    }
    ...
    public boolean isTokenValid(String token, User user) {
        return isTokenValid(token, UserEntityMapper.from(user));
    }
